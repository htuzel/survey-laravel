                ...
                <div class="card">
                    ...
                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ url("references/{$reference->id}") }}" method="POST" >
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row">
                                    <div class="form-group col-12">
                                        ...
                                        <textarea class="form-control" rows="3" id="name" name="name" required>{{ $reference->name }}</textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-9 col-12">
                                        <label for="link">@lang('Link')</label>
                                        <input type="text" class="form-control" id="link" name="link" value="{{ $reference->link }}">
                                    </div>
                                    <div class="form-group col-md-3 col-12">
                                        <label for="date">@lang('Date')</label>
                                        <input type="text" class="form-control" id="date" name="date" value="{{ $reference->date }}">
                                    </div>
                                </div>
